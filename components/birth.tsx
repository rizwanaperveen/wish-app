      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-sky-800">Happy Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-green-600"> I wish you abundant happiness and love</CardDescription>
            <p className="text-lg text-pink-800 font-serif font-bold">Tum jiyo Hazaron Saal</p>
          </CardHeader>
          {/* Card content with candles and balloons */}
          <CardContent className="space-y-6 text-center">
            {/* Candles section */}
            <div>
              <h3 className="text-lg font-semibold text-red-500 mb-2">Light the candles:</h3>
            ...
            {/* Balloons section */}
            <div>
              <h3 className="text-lg font-semibold text-red-500 mb-2">Pop the balloons:</h3>
              <div className="flex justify-center space-x-2">
          ...
          <CardFooter className="flex justify-center">
            <Button 
              className="bg-purple-600 text-white hover:bg-gray-800 transition-all duration-300"
              onClick={celebrate}
